...
const renderComments = (comments) => {
  ...
  comments.forEach((comment) => {
    ...
    commentItem.setAttribute('src', comment.avatar);
    commentItem.setAttribute('alt', comment.name);
    commentItem.setAttribute('width', 35);
    commentItem.setAttribute('height', 35);
    ...
    const commentItemImage = document.createElement('img').commentItemImageData;
    console.log(commentItemImage);
  });
};
