...
const test = document.querySelector('.img-upload__overlay');
...
const onModalEscKeydown = (evt) => {
  if (isEscapeKey(evt)) {
    ...
    closeForm();
    closeMessage();
    test.removeEventListener('keydown', onModalEscKeydown);
    deleteBodyFixedClass();
  }
};
...
const openForm = () => {
  ...
  test.addEventListener('keydown', onModalEscKeydown);
