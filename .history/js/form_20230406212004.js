...
const onClickOutsideSucessMessage = (evt) => {
  if (!evt.target.classList.contains('.success_inner')){
    closeMessage();
...
const onClickOutsideErrorMessage = (evt) => {
  if (!evt.target.classList.contains('.error_inner')){
    closeMessage();
...
const showSuccessMessage = () => {
  ...
  document.addEventListener('click', onClickOutsideSucessMessage);
...
const showErrorMesaage = () => {
  ...
  document.addEventListener('click', onClickOutsideErrorMessage);
  modalMessageHandlers();
};
