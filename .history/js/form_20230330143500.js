...
const errorFormTemplate = document.querySelector('#success').content;
...
const showSuccessMessage = () => {
  ...
  closeSuccessMessageButton.addEventListener('click', closeSucessMessage);
...
const showErrorMesaage = () => {
  const emessageTemplate = errorFormTemplate.cloneNode(true);
  // document.body.append(messageTemplate);
  console.log(emessageTemplate);
  // const closeSuccessMessageButton = document.querySelector('.success__button');
  // closeSuccessMessageButton.addEventListener('click', closeSucessMessage);
  // document.body.addEventListener('click', onClickEmptyAreaSucessMessage);
};
