...
const closeSucessMessage = (/* closeSuccessMessageButton */) => {
  const successMessage = document.querySelector('.success');
  if (successMessage) {
    successMessage.remove();
    // closeSuccessMessageButton.removeEventListener('click', closeSucessMessage);
  }
};
...
const onSucessSendFormMessage = () => {
  ...
  closeSuccessMessageButton.addEventListener('click', closeSucessMessage(closeSuccessMessageButton));
