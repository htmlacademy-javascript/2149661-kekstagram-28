...
const onSucessSendFormMessage = () => {
  ...
  messageTemplate.querySelector('.success__title').textContent = 'Изображение успешно загружено';
  messageTemplate.querySelector('.success__button').textContent = 'Круто!';
  document.body.insertAdjacentHTML('beforeend', messageTemplate);
