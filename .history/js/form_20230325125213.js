...
const hasUnicueHashTags = (hashTags) => {
  ...
  return toLowerCaseHashTags.length === new Set(hashTags).size;
  // toLowerCaseHashTags.every((hashTag) => {
  //   if (toLowerCaseHashTags[hashTag]) {
  //     return false;
  //   }
  //   toLowerCaseHashTags[hashTag] = hashTag;
  //   return true;
  // });
};
...
const hashTagValidate = (value) => {
  ...
  // return hasValidCount(hashTags) && hashTags.every(isValidHashTag);
