...
const effectsLevelSlider = document.querySelector('.effect-level__value');
...
const onSliderUpadte = () => {
  ...
  if (isDefailt){
    ...
    processedImage.style.filter = `${selectedEffect}(${sliderValue}${selectedEffect.unit})`
    effectsLevelSlider.value = sliderValue;
  }
};
