...
const idd = createRandomIdFromRangeGenerator(1, 25);
const iddTwo = createRandomIdFromRangeGenerator(0, (COMMENTS.length - 1) * 25);
...
const isNull = photoArchive.some((photo) => photo.comments.some((comment) => comment.id === null));
